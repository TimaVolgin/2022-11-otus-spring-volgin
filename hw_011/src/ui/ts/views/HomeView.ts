...
export default class HomeView extends Vue {
     ...
     */
    private async onBookShow(id: string) {
     ...
     * @param id идентификатор книги
     */
    private async onBookEdit(id: string) {
        await this.$router.push(`/book/edit/${id}`);
    }
     ...
     * @private
     */
    private showDeleteModal(id: string): void {
