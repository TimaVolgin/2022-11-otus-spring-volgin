...
public class BookDaoJdbc implements BookDao {
    ...
    public Book save(Book book) {
        ...
        jdbcOperations.update(INSERT_BOOK, new MapSqlParameterSource(params), keyHolder);
    ...
    public Book update(Book book) {
        ...
        jdbcOperations.update(UPDATE_BOOK, params);
        return book;
    }

    @Override
    public void deleteById(long id) {
        jdbcOperations.update(DELETE_BOOK_BY_ID, Map.of("id", id));
    }

    @Override
    public Optional<Book> findById(long id) {
        return Optional.ofNullable(jdbcOperations.query(SELECT_BOOK_BY_ID, Map.of("id", id),
                rs -> rs.next() ? bookMapper.mapRow(rs, 1) : null));
    }

    @Override
    public List<Book> findAll() {
        return jdbcOperations.query(SELECT_BOOKS, bookMapper);
    }

    @Override
    public List<Book> findAllByGenreName(String genreName) {
        return jdbcOperations.query(SELECT_BOOK_BY_GENRE_NAME, Map.of("genreName", genreName), bookMapper);
    }
