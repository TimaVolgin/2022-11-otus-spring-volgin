...
class CommentServiceImplTest {
    ...
    void saveTest() {
        ...
        verify(commentRepository).saveOrUpdate(argThat(actualSavedBookComment -> {
    ...
    void updateTest() {
        ...
        verify(commentRepository).saveOrUpdate(argThat(actualSavedComment -> {
    ...
    @Test
    void findById() {
        when(commentRepository.findById(1)).thenReturn(of(Comment.builder().build()));
        when(commentRepository.findById(2)).thenReturn(empty());
