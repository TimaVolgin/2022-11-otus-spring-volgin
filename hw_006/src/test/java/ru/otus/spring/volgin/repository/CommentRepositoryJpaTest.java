...
class CommentRepositoryJpaTest {
    ...
    void saveTest() {
        ...
        Optional<Comment> actualBookComment = commentRepositoryJpa.findById(expectedComment.getId());
    ...
    void updateTest() {
        Comment expectedBookComment = Comment.builder()
                ...
                .text("Тестовый комментарий")
                .build();
        commentRepositoryJpa.saveOrUpdate(expectedBookComment);
        Optional<Comment> actualBookComment = commentRepositoryJpa.findById(expectedBookComment.getId());
        assertTrue(actualBookComment.isPresent(), "Не найден комментарий");
    ...
    @Test
    void deleteByIdTest() {
        assertThat(commentRepositoryJpa.findById(11L)).isNotEmpty();
        commentRepositoryJpa.deleteById(11L);
        em.flush();
        assertThat(commentRepositoryJpa.findById(11L)).isEmpty();
    }
    ...
    void findByIdTest() {
        Comment expectedBookComment = Comment.builder()
                ...
                .book(em.find(Book.class, 2L))
                .build();
        Optional<Comment> actualBook = commentRepositoryJpa.findById(expectedBookComment.getId());
    ...
    void findAllTest() {
        Comment expectedBookComment = Comment.builder()
                ...
                .book(em.find(Book.class, 2L))
                .build();
        List<Comment> actualBookList = commentRepositoryJpa.findAll();
