...
@Component({
    ...
    <div class="book">
        <el-descriptions v-if="book"
            ...
            <el-descriptions-item label="Автор">{{book.author.fio}}</el-descriptions-item>
        ...
        <el-button type="success" @click="dialogFormVisible = true">Добавить комментарий</el-button>
        <el-dialog title="Добавление комментария" :visible.sync="dialogFormVisible">
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="success" @click="onAddComment">Сохранить</el-button>
          </span>
        </el-dialog>
    </div>
  `,
