...
class InteractionServiceByConsoleTest {
    ...
    void printResultTest(int correctAnswer, boolean isPassed) {
        ...
        Exam exam = Exam.builder().requiredCorrectAnswers(3).questionAttempts(1).shuffleAnswers(false)
                .student(Student.builder().firstName("Petr").lastName("Petrov").age(35).build()).build();
