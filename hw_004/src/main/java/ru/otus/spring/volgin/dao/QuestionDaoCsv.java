...
public class QuestionDaoCsv implements QuestionDao {
    ...
    public QuestionDaoCsv(ExamApplicationProperties properties, LocaleHolder localeHolder) {
    ...
    public List<Question> findAll() {
        String resourcePath = "/questions_" + localeHolder.getLocale() + "/" + scvResourceName;
